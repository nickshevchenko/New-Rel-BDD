@ST_13228 @tagtagtag @this_is_story_tag @new_changes
...
@SC_55727 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_55728 @third_scenario_tag
...
@SC_55729 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_55730 @fifth_scenario_tag
